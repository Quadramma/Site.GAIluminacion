        ...
        <div class="ga navbar container clearfix">
            ...
            <div class="pull-right">
                <nav class="navmenu center">
                    <ul>
                        <li class="liHome first active scroll_btn"><a ng-click="pushState('home')"  rel="home" href="#home">Home</a>
                        </li>
                        <li class="liColl scroll_btn"><a ng-click="pushState('coleccion')" rel="coleccion" href="#coleccion">Colección</a>
                        </li>
